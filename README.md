...
- TRC revenue rows show the portion retained from new and existing cashback amounts, hidden when exporting to PDF.
...
- TRC revenue for new and existing customers is derived from the cashback amounts and omitted from PDF exports.
