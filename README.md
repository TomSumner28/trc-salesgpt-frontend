...
- **Saved forecasts** – After calculating results you can save the current forecast. Saved items are stored in a shared Supabase table so anyone can revisit them later. Visit the Saved Forecasts page from the top bar to review or delete stored forecasts.
