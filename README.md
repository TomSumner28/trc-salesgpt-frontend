...
- **Saved forecasts** – After calculating results you can save the forecast to Supabase so anyone can revisit it later. Use the Saved Forecasts page to reopen or delete previous entries.
